      ...
      <div class="card card-body blur shadow-blur mx-4 mt-n6 overflow-hidden">
        <div class="row gx-4">
          <div class="col-auto">
            ...
            <img src="{{ asset('assets/img//small-logos/logo-spotify.svg') }}" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
            </div>
          </div>
              ...
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                  <div class="avatar me-3">
                    <img src="{{ asset('assets/img/kal-visualis-square.jpg') }}" alt="kal" class="border-radius-lg shadow">
                  </div>
                  ...
                  <div class="card card-blog card-plain">
                    <div class="position-relative">
                      <a class="d-block shadow-xl border-radius-xl">
                        <img src="{{ asset('assets/img/home-decor.jpg') }}" alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                      </a>
                    </div>
