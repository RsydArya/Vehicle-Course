        ...
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="card-body">
              ...
              <!-- Form Start -->
              <form action="{{route('user.registration')}}" role="form text-left" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <p class="text-sm mt-3 mb-0">Already have an account? <a href="{{ route('user.sign-in') }}" class="text-dark font-weight-bolder">Sign in</a></p>
              </form>
              <!-- Form End -->
